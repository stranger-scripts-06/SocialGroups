...
const ContentPratibimb = (props: Props) => {
  ...
  return (
    <HoverCard backgroundColor = '#d9b99b' direction='' left='0'>
    <div className='md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between '>
        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>Pratibimb</span> is the annual national level cultural festival of VJTI, initiated in 1987, it is the oldest and first cashless festival making it inimitable.</p>
        <div>
            <a onMouseEnter={() => setHoveredSite(true)} onMouseLeave={() => setHoveredSite(false)} href="http://pratibimbvjti.com/" className=' md:text-xl text-white font-semibold inline-block'>
                Visit Site
            ...
            &nbsp;
            &nbsp;
            <a onMouseEnter={() => setHoveredInstagram(true)} onMouseLeave={() => setHoveredInstagram(false)} href="https://www.instagram.com/pratibimbvjti/" className=' md:text-xl text-white font-semibold inline-block'>
                Visit Instagram
    ...
    <div className='overflow-hidden rounded-s-lg z-[1] flex-1 shadow-3xl'>
        ...
        <Image
        src="/pratibimb.png" // Path from the public directory
...
export default ContentPratibimb