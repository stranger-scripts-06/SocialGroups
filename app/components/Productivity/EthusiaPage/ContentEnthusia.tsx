...
const ContentEnthusia = (props: Props) => {
  ...
  return (
    <HoverCard backgroundColor = '#cb4154' direction='' left='0'>
    <div className='md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 justify-between '>
        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-medium'>Enthusia</span> is the annual Sports Festival at VJTI, Mumbai that promotes Sports, Fitness & Health as their goal.</p>
        <div>
            <a onMouseEnter={() => setHoveredSite(true)} onMouseLeave={() => setHoveredSite(false)} href="https://linktr.ee/enthusia2024" className=' md:text-xl text-white font-semibold inline-block'>
                Visit Site
            ...
            &nbsp;
            &nbsp;
            <a onMouseEnter={() => setHoveredInstagram(true)} onMouseLeave={() => setHoveredInstagram(false)} href="https://www.instagram.com/enthusiavjti/" className=' md:text-xl text-white font-semibold inline-block'>
                Visit Instagram
    ...
    <div className='overflow-hidden rounded-s-lg z-[1] flex-1 shadow-3xl'>
        ...
        <Image
        src="/enthusia.png" // Path from the public directory
...
export default ContentEnthusia