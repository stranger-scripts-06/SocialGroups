  ...
  return (
    ...
    <div className='flex items-center flex-row relative'>
        ...
        <img
            ...
            loading="lazy"
            decoding="async"
            src="C:\Users\abhij\Desktop\digi\digi final\GitCloneDigital\public\Sarth Bora.jpg"
        />
    </div>
    <div className='lg:pl-24 md:pl-16 pl-6'>
        ...
        <motion.div initial={{opacity:0, x:-30}} whileInView={{opacity:1, x:0}} transition={{type: "tween", delay:0.1}} className='mb-10 md:mb-32 pb-4 '>
            <div className='py-4 text-left'>
                ...
                <h3 className="text-[#FAF9F6] mb-12 mt-3 lg:text-6xl md:text-5xl text-3xl font-medium">Contact Us</h3>
